...
class COMPRESSORMAPMODEL():
    ...
    def VirtualAirVolumeFlowSensor(self):
        ...
        while num < self._outdata.shape[0]:
            ...
            try:
                h_dis = CP.CoolProp.PropsSI('H', 'P', High_p[num] * 100 * 1000, 'T', Tdis1[num]+ 273.15, 'R410A') / 1000
            except ValueError:
                h_dis = 0
            try:
    ...
    def VirtualRatedMassFlowSensor(self):
        ...
        while num < self._outdata.shape[0]:
            ...
            Tdis_real = self._outdata[self.DischargeTemp[0]][num] #(self._outdata[self.DischargeTemp[0]][num] + self._outdata[self.DischargeTemp[1]][num])/2
