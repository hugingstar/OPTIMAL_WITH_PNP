...
class DataCorrection:
    ...
    def PlottingMesurement(self, plt_ST, plt_ET, save, out_unit):
        ...
        ax3.plot(tt, solve['Temp_Inlet'].tolist(), 'b-', linewidth='2', drawstyle='steps-post', alpha= 0.6)
        ax3.plot(tt, solve['Temp_Outlet'].tolist(), 'r-', linewidth='2', drawstyle='steps-post', alpha= 0.6)
        ax4.plot(tt, solve['RH_Inlet'].tolist(), 'b-', linewidth='2', drawstyle='steps-post', alpha= 0.6)
        ax4.plot(tt, solve['RH_Outlet'].tolist(), 'r-', linewidth='2', drawstyle='steps-post', alpha= 0.6)
        ...
        ax3.legend(['Temperature Inlet(HOBO, {})'.format('$^{\circ}C$'), 'Temperature Outlet(HOBO, {})'.format('$^{\circ}C$')], fontsize=18, loc='upper right', ncol=2)
        ax4.legend(['Humidity Inlet (HOBO, RH %)', 'Humidity Outlet (HOBO, RH %)'], fontsize=18, loc='upper right', ncol=2)
        ...
        ax3.set_ylabel('Air temperature', fontsize=28)
        ax4.set_ylabel('Humidity', fontsize=28)
